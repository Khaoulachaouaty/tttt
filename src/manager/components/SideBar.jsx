...
const Array1 = [
  ...
  {text: "Pièce de rechange",icon: <InventoryOutlined />,path: "piece-rechange",},
...
const Array3 = [
  { text: "Historique des demandes", icon: <History />, path: "historique-des-demandes" },
  { text: "Interventions archivées", icon: <Archive />, path: "historique" },
  { text: "parametrage", icon: <Settings />, path: "parametrage" },
];
