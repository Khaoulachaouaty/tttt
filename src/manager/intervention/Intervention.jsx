...
const Intervention = () => {
  ...
  const loadTicketToltal = async () => {
    try {
      const response = await NombreTickets.getTotalTicketInter();
  ...
  const loadEnAttenteTicket = async () => {
    try {
      const response = await NombreTickets.getEnAttenteTicketInter();
  ...
  const loadTicketRealise = async () => {
    try {
      const response = await NombreTickets.getTicketReliserInter();
  ...
  const loadTicketARealise = async () => {
    try {
      const response = await NombreTickets.getTicketAReliserInter();
