...
const Equipement = () => {
  ...
  const [societeValue, setSocieteValue] = React.useState("");
  ...
  const handleUpdateConfirmOpen = () => {
    ...
    // @ts-ignore
    setSocieteValue(updated.client);
    // @ts-ignore
  ...
  const handleUpdateItem = async () => {
    try {
      ...
      console.log(updatedItem, "tttttttttt");
      await adminService.updateEquipement(updated.eqptCode), updatedItem;
      loadEqpm();
      setConfirmUpdateOpen(false);
      handleCloseMenu();
    } catch (error) {
  ...
  const filterEquipements = () => {
    ...
    const filteredResults = searchResults.filter((eqm) => {
      ...
      const matchesType = selectedType
        ? eqm.type.eqtyLibelle === selectedType
        : true;
        ...
        <Box sx={{ display: "flex", gap: 2, marginBottom: 2 }}>
          ...
          >
            ...
            {familles.map((famille, index) => (
              <MenuItem key={index} value={famille}>
                {famille}
              </MenuItem>
            ))}
          </Select>
                  ...
                  <div style={{ width: "246px" }} className="box">
                    <div style={{ position: "relative" }}>
                      ...
                      >
                        ...
                        <MenuItem
                          onClick={(event) =>
                            handleDeleteConfirmOpen(event, eqm)
                          }
                        >
                          Supprimer
                        </MenuItem>
                    ...
                    <p style={codeStyles} className="code">
                      Famille: {eqm.famille.eqfaLibelle}
                    </p>
                    <p style={codeStyles} className="code">
                      Type: {eqm.type.eqtyLibelle}
                    </p>
            ...
            >
              ...
              <Stack sx={{ gap: 2 }} direction={"row"}>
                ...
                <Autocomplete
                  ...
                  value={societeValue}
                  options={societe}
                  getOptionLabel={(option) => option.nomSociete} // Utilise la propriété 'libelle' comme label
                  isOptionEqualToValue={(option, value) =>
                    option.codeClient === value.codeClient
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    <TextField
                      ...
                      value={duregValue}
                      onChange={(e) =>
                        setDureGValue(parseFloat(e.target.value))
                      }
                      fullWidth
                    />
                  </Grid>
