...
import { Grid, Table, TableBody, TableCell, TableContainer, TableRow, Typography, useTheme } from "@mui/material";
import { Box, styled } from "@mui/material";
import { EditNote, RemoveRedEyeOutlined } from "@mui/icons-material";
...
const Intervention = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await ticketService.getTicketArchivedTehnicien();
